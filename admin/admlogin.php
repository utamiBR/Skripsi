...
if(isset($login)){
	if(mysqli_num_rows(mysqli_query($con,"select id from admin where username='$user' and password='$pass'")))
    {
        $tipe=mysqli_fetch_row(mysqli_query($con,"select id from admin where username='$user' and password='$pass'"));
